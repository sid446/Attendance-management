...
export const USER_PUT_KEY_TO_EMPLOYEE_TABS: Record<string, EmployeeManagementTabId[]> = {
  ...
  verticalTransfer1From: ['extended'],
  verticalTransfer1To: ['extended'],
  verticalTransfer1FromDate: ['extended'],
  verticalTransfer2From: ['extended'],
  verticalTransfer2To: ['extended'],
  verticalTransfer2FromDate: ['extended'],
  bankName: ['bank'],
  branchName: ['bank'],
  accountNumber: ['bank'],
  ifscCode: ['bank'],
